...
public class Server {
				...
				try{
					switch(messageType)
					{
						case 1: // Type A
							...
							printFile(pointCloud,numPoints);	
	...
	private void printFile(FloatBuffer floatBuffer,int numPoints) {
		int i=0;
		int count=0;
		float aux;
		try{
			PrintStream ps = new PrintStream("data_tango.txt");
